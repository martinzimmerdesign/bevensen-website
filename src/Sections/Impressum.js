...
const Impressum = () =>
      <div>
        <SectionWrapper title="Impressum">
        <div>
        ...
        <p><strong>Berufsrechtliche Regelungen:</strong><br />-&gt; Berufsordnung der&nbsp;<a href="http://www.aekn.de/" target="_blank" rel="noopener noreferrer">&Auml;rztekammer Niedersachsen</a><br />-&gt; Heilberufegesetz des Landes Niedersachsen</p>
        ...
        <p><strong>Design &amp; Programmierung</strong><br />Martin Zimmer Design<br /><a href="mailto:info@it42.gmbh">m.zimmer.business@gmail.com</a><br /><a href="https://martinzimmer.design/" target="_blank" rel="noopener noreferrer">martinzimmer.design</a></p>
        ...
        <p>Das Copyright im Rahmen dieser Publikation ver&ouml;ffentlichter Inhalte bleibt allein beim Autor dieser Seiten und dem Urheber der Fotografien und darf ohne derer Zustimmung nicht verwendet werden.</p>
        </div>
        </SectionWrapper>
    </div>
