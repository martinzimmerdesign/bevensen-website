...
render(){
  return(
    ...
    <div class="content_section_parent">
        <h1 class="elements-animate-in_bottom">Mitarbeiter</h1>

          <div class="line elements-animate-in_bottom"></div>
<h2 class="elements-animate-in_right">Unsere Ärzte</h2>
<div class="aerzte_image_parent">
  <div class="arzt_image_wrapper elements-animate-in_right">
...
<h2 class="elements-animate-in_right">Unser Team</h2>
<div class="team_image_parent elements-animate-in_right">
